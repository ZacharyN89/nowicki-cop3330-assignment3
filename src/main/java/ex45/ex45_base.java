...
public class ex45_base {
    public static void main(String[] args){
        findAndReplace run = new findAndReplace();
        //Set the path of the input file.
        String text = run.getFile();
        //Find and replace words from the given file and return as a string.
        text = run.replace(text);


        outputToFile writer = new outputToFile();
        //Print that string to a new file.
