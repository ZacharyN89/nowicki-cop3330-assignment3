...
public class ex46_base {
    public static void main(String[] args){
        countWords run = new countWords();
        System.out.print(
                run.makeChart( //Make the chart
                        run.countWords( //Get the number of times each word appears.
                                run.removeBlanks( //Remove blank words from the list.
                                        run.makeList( //Make a list out of the words.
                                                run.removeLineBreaks( //Remove newlines from the string.
                                                        run.parseFile())))))); //Turn the file into a string.
    }
}
